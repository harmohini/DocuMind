...
[![Live Frontend](https://img.shields.io/badge/Vite_Frontend-Vercel-000000?style=for-the-badge&logo=vercel)](https://docu-mind-gray.vercel.app/dashboard)
...
│(https://docu-mind-gray.vercel.app/dash) │
└────────────────────┬────────────────────┘
                     │ HTTP / REST (X-User-ID)
                     ▼
┌─────────────────────────────────────────┐
